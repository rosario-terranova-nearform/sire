...
export const cardVariants = cva('', {
  ...
  defaultVariants: {
    // Card bodies hold streaming counselor speech at body-copy sizes — the
    // bitmap face only ever lands on CardTitle (already text-base via
    // font-heading), never cascaded onto smaller description/content text.
    font: 'normal',
  },
})
